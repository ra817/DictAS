...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", type=str, default='checkpoints/dict_weights/clip_base', help='path to save checkpoint')
    ...
    parser.add_argument("--resume_path", type=str, default= "checkpoints/dict_weights/clip_base/train_mvtec/epoch_5.pth", help="resume_path")
